...
$PASSWORD = 'Appooafnan@007';  // Set the password, to access the file manager... (optional)
...
</style><form action=? method=post><h1><strong><code>Password:</h1></strong></code><input type=password name=p autofocus/></form></body></html>';
		exit;
	}
}
...
.name {
	...
	padding:15px 0 10px 40px;font-size:19px;
}
.is_dir .name {
	padding:15px 0 10px 40px;font-size:19px;
}
.download {
	padding:4px 0 4px 20px;font-size:19px;
}
list
</style>
